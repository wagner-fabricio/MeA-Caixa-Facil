            ...
            <div className="container mx-auto px-4 py-8 max-w-6xl">
                ...
                >
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                        <div>
                            <h1 className="text-4xl font-bold text-primary-navy dark:text-white mb-2">Receitas</h1>
                            <p className="text-gray-600 dark:text-gray-400">Gerencie todas as suas receitas</p>
                        </div>
                        <button
                    ...
                    {/* Total Income Card */}
                    <div className="bg-gradient-to-br from-semantic-income/20 to-semantic-income/5 border border-semantic-income/30 rounded-2xl p-6">
                        <p className="text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1">Total de Receitas</p>
                        <p className="text-4xl font-black text-semantic-income font-mono">
                                ...
                                >
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center gap-2 mt-2">
                                            <span className="inline-block px-3 py-1 rounded-lg text-xs font-semibold bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400">
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        <p className="text-2xl font-bold text-semantic-income font-mono">
